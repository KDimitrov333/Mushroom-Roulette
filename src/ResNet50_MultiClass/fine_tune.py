...
def main():
    ...
    saved_state_dict = torch.load("./models/resnet50_multi_class_best_mushroom_roulette.pth", weights_only=True)
    ...
    for epoch in range(epochs):
        ...
        if test_accuracy > best_accuracy:
            ...
            torch.save(model.state_dict(), "./models/resnet50_multi_class_fine_tuned_mushroom_roulette.pth")
        else:
            print("\n")
